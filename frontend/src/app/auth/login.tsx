...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Auth state update in layout will auto redirect
    } catch (err: any) {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          <View style={styles.logoContainer}>
            <Logo size={120} />
            <Text style={styles.subtitle}>Ignite your streak, pace your stride</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity onPress={() => setIsTermsOpen(true)} style={styles.termsBtn}>
              <Text style={styles.termsBtnText}>Terms & Conditions Policy</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
